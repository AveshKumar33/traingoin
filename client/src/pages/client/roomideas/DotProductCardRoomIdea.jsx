                    ...
                    <div>
                      ...
                      {dotproduct?.dotProductImageIds[0]?.image && (
                        <img
                          ...
                          className="buyfromelevationcardimage card-img-top RoomIdeaImageStyle"
                          alt={dotproduct?.name}
                        />
                      )}
                    </div>
...
export default DotProductCardRoomIdea;
