  ...
  const fetchRootCollection = useCallback(async () => {
    try {
      const { data } = await axiosInstance.get(
        `/api/header-image/title/TermsandCondition`
      );
      if (data?.success) {
    ...
    <>
      ...
      <div class="container">
        <div class="col-md-12">
          ...
          <p>Welcome to Railingo!</p>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of Railingo's Website, located at https://railingo.com/.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Railingo if you do not agree to
          ...
          <p>
            We employ the use of cookies. By accessing Railingo, you agreed to
            use cookies in agreement with the Railingo's Privacy Policy.{" "}
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, Railingo and/or its licensors own the
            intellectual property rights for all material on Railingo. All
            intellectual property rights are reserved. You may access this from
            Railingo for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Republish material from Railingo</li>
            <li>Sell, rent or sub-license material from Railingo</li>
            <li>Reproduce, duplicate or copy material from Railingo</li>
            <li>Redistribute content from Railingo</li>
          </ul>
          <p>
          ...
          <p>
            ...
            Railingo does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of Railingo,its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, Railingo shall
            not be liable for the Comments or for any liability, damages or
            expenses caused and/or suffered as a result of any use of and/or
            posting of and/or appearance of the Comments on this website.
          </p>
          <p>
            Railingo reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant Railingo a non-exclusive license to use, reproduce,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Railingo; and
          ...
          <p>
            ...
            sending an e-mail to Railingo. Please include your name, your
          ...
          <p>
            No use of Railingo's logo or other artwork will be allowed for
