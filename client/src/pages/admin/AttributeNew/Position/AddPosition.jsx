...
import { createPosition } from "../../../../redux/slices/positionSlice";
...
const AddPosition = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    dispatch(createPosition({ ...formData, attributeId: id }));

    if (loading === "fulfilled") {
      navigate(`/admin/attribute/position/${attributeName}/${id}`);
    }
  };
