...
import { createdotProduct } from "../../../redux/slices/dotProductSliceNew";
...
const AddDotProduct = () => {
  const { loading } = useSelector((state) => state.newDotProduct);
  ...
  const handleSubmit = async (e) => {
    ...
    dispatch(createdotProduct(dotproductdata));
