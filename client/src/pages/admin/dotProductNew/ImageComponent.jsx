...
import { fetchProductsForBundle } from "../../../redux/slices/newProductSlice";
...
const ImageComponent = ({
  ...
  useEffect(() => {
    dispatch(fetchProductsForBundle());
  }, [dispatch]);
  ...
  const onSelectFile = (e) => {
    ...
    if (e.target.files[0].size >= 10000000) {
      e.target.value = null;
      setSelectedFile(undefined);
      toastError("Image should be less than 10 MB");
      return;
    }
  ...
  return (
    <>
      ...
      {showOnly && <input type="file" onChange={onSelectFile} />}
      <br></br>
      <br></br>
