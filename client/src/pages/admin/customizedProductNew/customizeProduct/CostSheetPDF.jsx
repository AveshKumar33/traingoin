...
const getPrice = (width, height, fixedAmount, unit, productdetails) => {
  let P_Width = width || 0;
  let P_Height = height || 0;
  ...
  switch (unit) {
    ...
    case "Pice":
      break;
    case "Sq.ft":
      price = price * P_Height || 0 * P_Width || 0;
      break;
    case "Length":
      price = price * P_Height || 0;
      break;
    case "Width":
      price = price * P_Width || 0;
      break;
    default:
  }
...
const CostSheetPDF = ({
        ...
        (sum, item) =>
          ...
          (item?.combinations[0]?.parameterId?.price
            ? getPrice(
                ...
                P_Height,
                item.combinations[0]?.parameterId?.price,
                getUOM(UOM, item?.attributeId?.UOMId),
                productdetails
              )
            : 0),
  ...
  }, [BackSide, FrontCombination, P_Width, P_Height, UOM, productdetails]);
